...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'toimg$', fromMe: true, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
    ...
    Asena.addCommand({pattern: 'toimg$', fromMe: false, desc: Lang.STİCKER_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'mp4audio', fromMe: true, dontAddCommandList: true, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'toimg$', fromMe: true, dontAddCommandList: true, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
