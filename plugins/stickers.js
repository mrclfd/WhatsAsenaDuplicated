...
if (Config.WORKTYPE == 'private') {
  ...
  */
   ...
   /* // GET TELEGRAM STICKER LINK
    ...
    Asena.addCommand({pattern: 'get$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
	...
	Asena.addCommand({pattern: 'get$', fromMe: true, dontAddCommandList: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
