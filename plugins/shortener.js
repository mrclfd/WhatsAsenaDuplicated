...
if (Config.WORKTYPE == 'public') {
 ...
 // s.id SHORTENER
    Asena.addCommand({ pattern: 'sid ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.SID_DESC }, async (message, match) => {
  ...
  // shorturl.at SHORTENER
     Asena.addCommand({ pattern: 'sat ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.SAT_DESC }, async (message, match) => {
  ...
  // cutt.ly SHORTENER
     Asena.addCommand({ pattern: 'cutt ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.CUTTLY_DESC }, async (message, match) => {
 ...
 // bit.ly SHORTENER
    Asena.addCommand({ pattern: 'bitly ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.BITLY_DESC }, async (message, match) => {
 ...
 // gg.gg SHORTENER
    Asena.addCommand({ pattern: 'gg ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.GG_DESC }, async (message, match) => {
 ...
 // shrtco.de SHORTENER
    Asena.addCommand({ pattern: 'shrtco ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.SHRT_DESC }, async (message, match) => {
 ...
 // tinyurl.com SHORTENER
    Asena.addCommand({pattern: 'tinyurl ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.TINYURL_DESC }, (async (message, match) => {
