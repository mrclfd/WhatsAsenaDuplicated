...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', desc: Lang.CURRENCY_DESC, fromMe: true}, (async (message, match) => {
    ...
    if (config.LANG == 'ID' || config.LANG == 'AZ') {
    ...
    Asena.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', desc: Lang.CURRENCY_DESC, fromMe: false}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'tr(?: |$)(\\S*) ?(\\S*)', dontAddCommandList: true, desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', dontAddCommandList: true, desc: Lang.CURRENCY_DESC, fromMe: true}, (async (message, match) => {
    ...
    if (config.LANG == 'ID' || config.LANG == 'AZ') {
        ...
        Asena.addCommand({pattern: 'tts (.*)', fromMe: true, dontAddCommandList: true, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'video ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'yt ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'wiki ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'img ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'github ?(.*)', fromMe: true, dontAddCommandList: true, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Asena.addCommand({pattern: 'lyric ?(.*)', fromMe: true, dontAddCommandList: true, desc: Slang.LY_DESC }, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: "covid ?(.*)", fromMe: true, dontAddCommandList: true, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
                //const resp = await fetch("https://coronavirus-19-api.herokuapp.com/all").then(r => r.json());
                const respo = await got("https://coronavirus-19-api.herokuapp.com/all").then(async ok => {
