...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'animesay ?(.*)', fromMe: true, desc: Lang.ANIME_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Anime say - BOT' })
    ...
    Asena.addCommand({ pattern: 'changesay ?(.*)', fromMe: true, desc: Lang.CHANGE_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Change my mind say - BOT' })
    ...
    Asena.addCommand({ pattern: 'trumpsay ?(.*)', fromMe: true, desc: Lang.TRUMP_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Trump say - BOT' })
    ...
    Asena.addCommand({ pattern: 'animesay ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.ANIME_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'changesay ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.CHANGE_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'trumpsay ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.TRUMP_DESC }, (async (message, match) => {
