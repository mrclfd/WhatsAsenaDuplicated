...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'carbon ?(.*)', fromMe: true, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: wm})
    ...
    Asena.addCommand({pattern: 'carbon ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN}, (async (message, match) => {
