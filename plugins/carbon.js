...
const butuh = "```Balas pesan apapun!```"
    ...
    Asena.addCommand({pattern: 'carbon$', fromMe: true, desc: carbon, usage: usage}, (async (message, match) => {

        if (!message.reply_message) return await message.client.sendMessage(message.jid, butuh, MessageType.text);
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: "Made with *TARGN-Userbot*"})
